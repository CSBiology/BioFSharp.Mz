...
module MzIdentMLModel =
    ...
    module Db =
        ...
        module DBSequence =
            ...
            let createDBSequenceParamTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    FKTerm TEXT NOT NULL,
                    FKUnit TEXT,
                    Value TEXT,
                    RowVersion BLOB(8) NOT NULL DEFAULT 0,
                    PRIMARY KEY (ID) ,
                    CONSTRAINT FK_Param_DBSequence_ID FOREIGN KEY (FKParamContainer) REFERENCES DBSequence (ID),
                    CONSTRAINT FK_DBSequenceTerm_Term_ID FOREIGN KEY (FKTerm) REFERENCES Term (ID),
                    CONSTRAINT FK_DBSequenceUnit_Term_ID FOREIGN KEY (FKUnit) REFERENCES Term (ID))"
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
        ...
        module PeptideEvidence =
            ...
            let createPeptideEvidenceParamTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    RowVersion BLOB(8) NOT NULL DEFAULT 0,
                    PRIMARY KEY (ID) ,
                    CONSTRAINT FK_Param_PeptideEvidence_ID FOREIGN KEY (FKParamContainer) REFERENCES PeptideEvidence (ID),
                    CONSTRAINT FK_PeptideEvidenceTerm_Term_ID FOREIGN KEY (FKTerm) REFERENCES Term (ID),
                    CONSTRAINT FK_PeptideEvidenceUnit_Term_ID FOREIGN KEY (FKUnit) REFERENCES Term (ID))"
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
        ...
        module Peptide =
            ...
            let createPeptideParamTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    RowVersion BLOB(8) NOT NULL DEFAULT 0,
                    PRIMARY KEY (ID) ,
                    CONSTRAINT FK_Param_Peptide_ID FOREIGN KEY (FKParamContainer) REFERENCES Peptide (ID),
                    CONSTRAINT FK_PeptideTerm_Term_ID FOREIGN KEY (FKTerm) REFERENCES Term (ID),
                    CONSTRAINT FK_PeptideUnit_Term_ID FOREIGN KEY (FKUnit) REFERENCES Term (ID))"
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
        ...
        module SpectrumIdentificationItem =
            ...
            let createSpectrumIdentificationItemParamTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    RowVersion BLOB(8) NOT NULL DEFAULT 0,
                    PRIMARY KEY (ID) ,
                    CONSTRAINT FK_Param_SpectrumIdentificationItem_ID FOREIGN KEY (FKParamContainer) REFERENCES SpectrumIdentificationItem (ID),
                    CONSTRAINT FK_SpectrumIdentificationItemTerm_Term_ID FOREIGN KEY (FKTerm) REFERENCES Term (ID),
                    CONSTRAINT FK_SpectrumIdentificationItemUnit_Term_ID FOREIGN KEY (FKUnit) REFERENCES Term (ID))"
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
        ...
        module Term =
            ...
            let createTermParamTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    RowVersion BLOB(8) NOT NULL DEFAULT 0,
                    PRIMARY KEY (ID) ,
                    CONSTRAINT FK_Param_Term_ID FOREIGN KEY (FKParamContainer) REFERENCES Term (ID),
                    CONSTRAINT FK_TermTerm_Term_ID FOREIGN KEY (FKTerm) REFERENCES Term (ID),
                    CONSTRAINT FK_TermUnit_Term_ID FOREIGN KEY (FKUnit) REFERENCES Term (ID))"
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
            ...
            let prepareSelectTermbyID (cn:SQLiteConnection) tr =
                ...
                let rec readerloop (reader:SQLiteDataReader) (acc) =
                    match reader.Read() with
                    | true  -> readerloop reader  ((reader.GetString(0), reader.GetInt32(1), reader.GetString(2), reader.GetDateTime(3) ) :: acc)
                    | false ->  acc 
                fun id->
                cmd.Parameters.["@ id "].Value <- id
                use reader = cmd.ExecuteReader() 
        ...
        module SpectrumIdentificationResult =
            ...
            let createSpectrumIdentificationResultParamTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    RowVersion BLOB(8) NOT NULL DEFAULT 0,
                    PRIMARY KEY (ID) ,
                    CONSTRAINT FK_Param_SpectrumIdentificationResult_ID FOREIGN KEY (FKParamContainer) REFERENCES SpectrumIdentificationResult (ID),
                    CONSTRAINT FK_SpectrumIdentificationResultTerm_Term_ID FOREIGN KEY (FKTerm) REFERENCES Term (ID),
                    CONSTRAINT FK_SpectrumIdentificationResultUnit_Term_ID FOREIGN KEY (FKUnit) REFERENCES Term (ID))"
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
        ...
        module SpectrumIdentificationList =
            ...
            let createSpectrumIdentificationListParamTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    RowVersion BLOB(8) NOT NULL DEFAULT 0,
                    PRIMARY KEY (ID) ,
                    CONSTRAINT FK_Param_SpectrumIdentificationList_ID FOREIGN KEY (FKParamContainer) REFERENCES SpectrumIdentificationList (ID),
                    CONSTRAINT FK_SpectrumIdentificationListTerm_Term_ID FOREIGN KEY (FKTerm) REFERENCES Term (ID),
                    CONSTRAINT FK_SpectrumIdentificationListUnit_Term_ID FOREIGN KEY (FKUnit) REFERENCES Term (ID))"
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
        ...
        module ModLocation =
            ...
            let createModLocationParamTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    RowVersion BLOB(8) NOT NULL DEFAULT 0,
                    PRIMARY KEY (ID) ,
                    CONSTRAINT FK_Param_ModLocation_ID FOREIGN KEY (FKParamContainer) REFERENCES ModLocation (ID),
                    CONSTRAINT FK_ModLocationTerm_Term_ID FOREIGN KEY (FKTerm) REFERENCES Term (ID),
                    CONSTRAINT FK_ModLocationUnit_Term_ID FOREIGN KEY (FKUnit) REFERENCES Term (ID))"
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
        ...
        module Modification =
            ...
            let createModificationParamTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    RowVersion BLOB(8) NOT NULL DEFAULT 0,
                    PRIMARY KEY (ID) ,
                    CONSTRAINT FK_Param_Modification_ID FOREIGN KEY (FKParamContainer) REFERENCES Modification (ID),
                    CONSTRAINT FK_ModificationTerm_Term_ID FOREIGN KEY (FKTerm) REFERENCES Term (ID),
                    CONSTRAINT FK_ModificationUnit_Term_ID FOREIGN KEY (FKUnit) REFERENCES Term (ID))"
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
        ...
        module Ontology =
            ...
            let createOntologyParamTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    RowVersion BLOB(8) NOT NULL DEFAULT 0,
                    PRIMARY KEY (ID) ,
                    CONSTRAINT FK_Param_Ontology_ID FOREIGN KEY (FKParamContainer) REFERENCES Ontology (ID),
                    CONSTRAINT FK_OntologyTerm_Term_ID FOREIGN KEY (FKTerm) REFERENCES Term (ID),
                    CONSTRAINT FK_OntologyUnit_Term_ID FOREIGN KEY (FKUnit) REFERENCES Term (ID))"
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
            ...
            let prepareSelectOntologybyID (cn:SQLiteConnection) tr =
                ...
                let rec readerloop (reader:SQLiteDataReader) (acc) =
                    match reader.Read() with
                    | true  -> readerloop reader  ((reader.GetString(0), reader.GetString(1) ) :: acc)
                    | false ->  acc 
                fun id->
                cmd.Parameters.["@ id "].Value <- id
                use reader = cmd.ExecuteReader() 
        ...
        module TermTag =
            ...
            let createTermTagParamTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    RowVersion BLOB(8) NOT NULL DEFAULT 0,
                    PRIMARY KEY (ID) ,
                    CONSTRAINT FK_Param_TermTag_ID FOREIGN KEY (FKParamContainer) REFERENCES TermTag (ID),
                    CONSTRAINT FK_TermTagTerm_Term_ID FOREIGN KEY (FKTerm) REFERENCES Term (ID),
                    CONSTRAINT FK_TermTagUnit_Term_ID FOREIGN KEY (FKUnit) REFERENCES Term (ID))"
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
            ...
            let prepareInsertTermTag (cn:SQLiteConnection) tr =
                ...
                let cmd = new SQLiteCommand(querystring, cn, tr)
                cmd.Parameters.Add("@id",Data.DbType.Int32) |> ignore
                cmd.Parameters.Add("@termid",Data.DbType.String) |> ignore
                cmd.Parameters.Add("@name",Data.DbType.String) |> ignore
                cmd.Parameters.Add("@value",Data.DbType.String) |> ignore
                cmd.Parameters.Add("@rowversion",Data.DbType.DateTime) |> ignore
        ...
        module TermRelationShip =
            ...
            let createTermRelationShipParamTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    RowVersion BLOB(8) NOT NULL DEFAULT 0,
                    PRIMARY KEY (ID) ,
                    CONSTRAINT FK_Param_TermRelationShip_ID FOREIGN KEY (FKParamContainer) REFERENCES TermRelationShip (ID),
                    CONSTRAINT FK_TermRelationShipTerm_Term_ID FOREIGN KEY (FKTerm) REFERENCES Term (ID),
                    CONSTRAINT FK_TermRelationShipUnit_Term_ID FOREIGN KEY (FKUnit) REFERENCES Term (ID))"
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
        ...
        module ProteinDetectionHypothesis =
            ...
            let createProteinDetectionHypothesisParamTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    RowVersion BLOB(8) NOT NULL DEFAULT 0,
                    PRIMARY KEY (ID) ,
                    CONSTRAINT FK_Param_ProteinDetectionHypothesis_ID FOREIGN KEY (FKParamContainer) REFERENCES ProteinDetectionHypothesis (ID),
                    CONSTRAINT FK_ProteinDetectionHypothesisTerm_Term_ID FOREIGN KEY (FKTerm) REFERENCES Term (ID),
                    CONSTRAINT FK_ProteinDetectionHypothesisUnit_Term_ID FOREIGN KEY (FKUnit) REFERENCES Term (ID))"
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
        ...
        module ProteinDetectionList =
            ...
            let createProteinDetectionListParamTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    RowVersion BLOB(8) NOT NULL DEFAULT 0,
                    PRIMARY KEY (ID) ,
                    CONSTRAINT FK_Param_ProteinDetectionList_ID FOREIGN KEY (FKParamContainer) REFERENCES ProteinDetectionList (ID),
                    CONSTRAINT FK_ProteinDetectionListTerm_Term_ID FOREIGN KEY (FKTerm) REFERENCES Term (ID),
                    CONSTRAINT FK_ProteinDetectionListUnit_Term_ID FOREIGN KEY (FKUnit) REFERENCES Term (ID))"
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
        ...
        module PeptideHypothesis =
            ...
            let createPeptideHypothesisParamTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    RowVersion BLOB(8) NOT NULL DEFAULT 0,
                    PRIMARY KEY (ID) ,
                    CONSTRAINT FK_Param_PeptideHypothesis_ID FOREIGN KEY (FKParamContainer) REFERENCES PeptideHypothesis (ID),
                    CONSTRAINT FK_PeptideHypothesisTerm_Term_ID FOREIGN KEY (FKTerm) REFERENCES Term (ID),
                    CONSTRAINT FK_PeptideHypothesisUnit_Term_ID FOREIGN KEY (FKUnit) REFERENCES Term (ID))"
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
        ...
        module ProteinAmbiguityGroup =
            ...
            let createProteinAmbiguityGroupParamTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    RowVersion BLOB(8) NOT NULL DEFAULT 0,
                    PRIMARY KEY (ID) ,
                    CONSTRAINT FK_Param_ProteinAmbiguityGroup_ID FOREIGN KEY (FKParamContainer) REFERENCES ProteinAmbiguityGroup (ID),
                    CONSTRAINT FK_ProteinAmbiguityGroupTerm_Term_ID FOREIGN KEY (FKTerm) REFERENCES Term (ID),
                    CONSTRAINT FK_ProteinAmbiguityGroupUnit_Term_ID FOREIGN KEY (FKUnit) REFERENCES Term (ID))"
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
        ...
        module SpectrumIdentification =
            ...
            let createSpectrumIdentificationTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    CONSTRAINT FK_SpectrumIdentification_SpectrumIdentificationProtocol_ID FOREIGN KEY (SpectrumIdentficationProtocolID) REFERENCES SpectrumIdentificationProtocol (ID)
                    )" 
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
            ...
            let createSpectrumIdentificationParamTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    RowVersion BLOB(8) NOT NULL DEFAULT 0,
                    PRIMARY KEY (ID) ,
                    CONSTRAINT FK_Param_SpectrumIdentification_ID FOREIGN KEY (FKParamContainer) REFERENCES SpectrumIdentification (ID),
                    CONSTRAINT FK_SpectrumIdentificationTerm_Term_ID FOREIGN KEY (FKTerm) REFERENCES Term (ID),
                    CONSTRAINT FK_SpectrumIdentificationUnit_Term_ID FOREIGN KEY (FKUnit) REFERENCES Term (ID))"
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
        ...
        module SpectrumIdentificationProtocol =
            ...
            let createSpectrumIdentificationProtocolTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    PRIMARY KEY (ID) ,
                    CONSTRAINT FK_SpecIdentProtocol_AnalysisSoftware_ID FOREIGN KEY (AnalysisSoftwareID) REFERENCES AnalysisSoftware (ID)
                    )" 
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
            ...
            let createSpectrumIdentificationProtocolParamTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    RowVersion BLOB(8) NOT NULL DEFAULT 0,
                    PRIMARY KEY (ID) ,
                    CONSTRAINT FK_Param_SpectrumIdentificationProtocol_ID FOREIGN KEY (FKParamContainer) REFERENCES SpectrumIdentificationProtocol (ID),
                    CONSTRAINT FK_SpectrumIdentificationProtocolTerm_Term_ID FOREIGN KEY (FKTerm) REFERENCES Term (ID),
                    CONSTRAINT FK_SpectrumIdentificationProtocolUnit_Term_ID FOREIGN KEY (FKUnit) REFERENCES Term (ID))"
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
        ...
        module ProteinDetectionProtocol =
            ...
            let createProteinDetectionProtocolParamTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    CONSTRAINT FK_ProteinDetectionProtocolTerm_Term_ID FOREIGN KEY (FKTerm) REFERENCES Term (ID),
                    CONSTRAINT FK_ProteinDetectionProtocolUnit_Term_ID FOREIGN KEY (FKUnit) REFERENCES Term (ID))"
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
        ...
        module Person =
            ...
            let createPerson id firstname lastname middlename organisationid rowversion  = {
                ID=id; FirstName=firstname; LastName=lastname; MiddleName=middlename; OrganisationID=organisationid; RowVersion=rowversion; ParamContainer=System.Collections.Generic.Dictionary<TermId,CvParam>()}

            let createPersonWith id firstname lastname middlename organisationid rowversion (cvParams:seq<CvParam>) = {
                ID=id; FirstName=firstname; LastName=lastname; MiddleName=middlename; OrganisationID=organisationid; RowVersion=rowversion; ParamContainer=ParamContainer.ofSeq cvParams}
            ...
            let createPersonTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    RowVersion BLOB(8) NOT NULL,
                    PRIMARY KEY (ID) ,
                    CONSTRAINT FK_Person_Organization_ID FOREIGN KEY (OrganisationID) REFERENCES Organization (ID)
                    )" 
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
            ...
            let createPersonParamTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    RowVersion BLOB(8) NOT NULL DEFAULT 0,
                    PRIMARY KEY (ID) ,
                    CONSTRAINT FK_Param_Person_ID FOREIGN KEY (FKParamContainer) REFERENCES Person (ID),
                    CONSTRAINT FK_PersonTerm_Term_ID FOREIGN KEY (FKTerm) REFERENCES Term (ID),
                    CONSTRAINT FK_PersonUnit_Term_ID FOREIGN KEY (FKUnit) REFERENCES Term (ID))"
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
            ...
            let prepareInsertPerson (cn:SQLiteConnection) tr =
                ...
                let cmd = new SQLiteCommand(querystring, cn, tr)
                cmd.Parameters.Add("@id",Data.DbType.Int32) |> ignore
                cmd.Parameters.Add("@firstname",Data.DbType.String) |> ignore
                cmd.Parameters.Add("@lastname",Data.DbType.String) |> ignore
                cmd.Parameters.Add("@middlename",Data.DbType.String) |> ignore
                cmd.Parameters.Add("@organisationid",Data.DbType.Int32) |> ignore
                cmd.Parameters.Add("@rowversion",Data.DbType.DateTime) |> ignore
                (fun id firstname lastname middlename organisationid rowversion ->
                    cmd.Parameters.["@id"].Value <- id
                    cmd.Parameters.["@firstname"].Value <- firstname
                    cmd.Parameters.["@lastname"].Value <- lastname
                    cmd.Parameters.["@middlename"].Value <- middlename
                    cmd.Parameters.["@organisationid"].Value <- organisationid
                    cmd.Parameters.["@rowversion"].Value <- rowversion
                    cmd.ExecuteNonQuery()
                    )
            ...
            let prepareSelectPersonbyID (cn:SQLiteConnection) tr =
                ...
                let rec readerloop (reader:SQLiteDataReader) (acc) =
                    match reader.Read() with
                    | true  -> readerloop reader  ((reader.GetInt32(0), reader.GetString(1), reader.GetString(2), reader.GetString(3), reader.GetInt32(4), reader.GetDateTime(5) ) :: acc)
                    | false ->  acc 
                fun id->
                cmd.Parameters.["@ id "].Value <- id
                use reader = cmd.ExecuteReader() 
                ...
                ///
            let prepareSelectPersonbyFirstName (cn:SQLiteConnection) tr =
                let querystring = 
                    "SELECT * FROMPerson WHERE FirstName=@firstname" 
                let cmd = new SQLiteCommand(querystring, cn, tr)
                cmd.Parameters.Add("@ firstname ",Data.DbType.String) |> ignore
                let rec readerloop (reader:SQLiteDataReader) (acc) =
                    match reader.Read() with
                ...
                ///
            let prepareSelectPersonbyLastName (cn:SQLiteConnection) tr =
                let querystring = 
                    "SELECT * FROMPerson WHERE LastName=@lastname" 
                let cmd = new SQLiteCommand(querystring, cn, tr)
                cmd.Parameters.Add("@ lastname ",Data.DbType.String) |> ignore
                let rec readerloop (reader:SQLiteDataReader) (acc) =
                    match reader.Read() with
                ...
                ///
            let prepareSelectPersonbyMiddleName (cn:SQLiteConnection) tr =
                let querystring = 
                    "SELECT * FROMPerson WHERE MiddleName=@middlename" 
                let cmd = new SQLiteCommand(querystring, cn, tr)
                cmd.Parameters.Add("@ middlename ",Data.DbType.String) |> ignore
                let rec readerloop (reader:SQLiteDataReader) (acc) =
                    match reader.Read() with
                ...
                ///
            let prepareSelectPersonbyOrganisationID (cn:SQLiteConnection) tr =
                let querystring = 
                    "SELECT * FROMPerson WHERE OrganisationID=@organisationid" 
                let cmd = new SQLiteCommand(querystring, cn, tr)
                cmd.Parameters.Add("@ organisationid ",Data.DbType.Int32) |> ignore
                let rec readerloop (reader:SQLiteDataReader) (acc) =
                    match reader.Read() with
        ...
        module Organization =
            ...
            let createOrganization id name parent_id rowversion  = {
                ID=id; Name=name; Parent_ID=parent_id; RowVersion=rowversion; ParamContainer=System.Collections.Generic.Dictionary<TermId,CvParam>()}

            let createOrganizationWith id name parent_id rowversion (cvParams:seq<CvParam>) = {
                ID=id; Name=name; Parent_ID=parent_id; RowVersion=rowversion; ParamContainer=ParamContainer.ofSeq cvParams}
            ...
            let createOrganizationTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    RowVersion BLOB(8) NOT NULL DEFAULT 8,
                    PRIMARY KEY (ID) ,
                    CONSTRAINT FK_Organization_Parent_ID FOREIGN KEY (Parent_ID) REFERENCES Parent (ID)
                    )" 
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
            ...
            let createOrganizationParamTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    RowVersion BLOB(8) NOT NULL DEFAULT 0,
                    PRIMARY KEY (ID) ,
                    CONSTRAINT FK_Param_Organization_ID FOREIGN KEY (FKParamContainer) REFERENCES Organization (ID),
                    CONSTRAINT FK_OrganizationTerm_Term_ID FOREIGN KEY (FKTerm) REFERENCES Term (ID),
                    CONSTRAINT FK_OrganizationUnit_Term_ID FOREIGN KEY (FKUnit) REFERENCES Term (ID))"
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
            ...
            let prepareInsertOrganization (cn:SQLiteConnection) tr =
                ...
                cmd.Parameters.Add("@id",Data.DbType.Int32) |> ignore
                cmd.Parameters.Add("@name",Data.DbType.String) |> ignore
                cmd.Parameters.Add("@parent_id",Data.DbType.String) |> ignore
                cmd.Parameters.Add("@rowversion",Data.DbType.DateTime) |> ignore
                (fun id name parent_id rowversion ->
                    cmd.Parameters.["@id"].Value <- id
                    cmd.Parameters.["@name"].Value <- name
            ...
            let prepareSelectOrganizationbyName (cn:SQLiteConnection) tr =
                ...
                ///
            let prepareSelectOrganizationbyParent_ID (cn:SQLiteConnection) tr =
                let querystring = 
                    "SELECT * FROMOrganization WHERE Parent_ID=@parent_id" 
                let cmd = new SQLiteCommand(querystring, cn, tr)
                cmd.Parameters.Add("@ parent_id ",Data.DbType.String) |> ignore
                let rec readerloop (reader:SQLiteDataReader) (acc) =
                    match reader.Read() with
        ...
        module AnalysisSoftware =
            ...
            let createAnalysisSoftwareParamTable (cn:SQLiteConnection) =
                let querystring = 
                    ...
                    RowVersion BLOB(8) NOT NULL DEFAULT 0,
                    PRIMARY KEY (ID) ,
                    CONSTRAINT FK_Param_AnalysisSoftware_ID FOREIGN KEY (FKParamContainer) REFERENCES AnalysisSoftware (ID),
                    CONSTRAINT FK_AnalysisSoftwareTerm_Term_ID FOREIGN KEY (FKTerm) REFERENCES Term (ID),
                    CONSTRAINT FK_AnalysisSoftwareUnit_Term_ID FOREIGN KEY (FKUnit) REFERENCES Term (ID))"
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()
        ...
        module Parent =
            ...
            let createParent id name country rowversion  = {
                ID=id; Name=name; Country=country; RowVersion=rowversion; ParamContainer=System.Collections.Generic.Dictionary<TermId,CvParam>()}

            let createParentWith id name country rowversion (cvParams:seq<CvParam>) = {
                ID=id; Name=name; Country=country; RowVersion=rowversion; ParamContainer=ParamContainer.ofSeq cvParams}

            let addOrUpDateInPlace (param:CvParam)  (parent:Parent)  = 
                ParamContainer.addOrUpdateInPlace param parent.ParamContainer |> ignore
                parent

            let createParentTable (cn:SQLiteConnection) =
                let querystring = 
                    "CREATE TABLE Parent (
                    ID INTEGER NOT NULL,
                    Name TEXT NOT NULL,
            ...
            let createParentParamTable (cn:SQLiteConnection) =
                let querystring = 
                    "CREATE TABLE ParentParam (
                    ID INTEGER NOT NULL,
                    FKParamContainer INTEGER NOT NULL,
                    FKTerm TEXT NOT NULL,
                    FKUnit TEXT,
                    ...
                    RowVersion BLOB(8) NOT NULL DEFAULT 0,
                    PRIMARY KEY (ID) ,
                    CONSTRAINT FK_Param_Parent_ID FOREIGN KEY (FKParamContainer) REFERENCES Parent (ID),
                    CONSTRAINT FK_ParentTerm_Term_ID FOREIGN KEY (FKTerm) REFERENCES Term (ID),
                    CONSTRAINT FK_ParentUnit_Term_ID FOREIGN KEY (FKUnit) REFERENCES Term (ID))"
                let cmd  = new SQLiteCommand(querystring, cn)
                cmd.ExecuteNonQuery()

            let prepareInsertParent (cn:SQLiteConnection) tr =
                let querystring = 
                    "INSERT INTO Parent (
                        ID,
                        Name,
                ...
                cmd.Parameters.Add("@id",Data.DbType.Int32) |> ignore
                cmd.Parameters.Add("@name",Data.DbType.String) |> ignore
                cmd.Parameters.Add("@country",Data.DbType.String) |> ignore
                cmd.Parameters.Add("@rowversion",Data.DbType.DateTime) |> ignore
                (fun id name country rowversion ->
                    cmd.Parameters.["@id"].Value <- id
                    cmd.Parameters.["@name"].Value <- name
            ...
            let prepareInsertParentParam (cn:SQLiteConnection) tr =
                let querystring = 
                    "INSERT INTO ParentParam (
                        ID,
                        FKParamContainer,
                        FKTerm,
                        FKUnit,
            ...
            let insertParentToDb insertInTableF insertInParamTableF parent =
                 insertInTableF
                    parent.ID
                    parent.Name
                    parent.Country
                    parent.RowVersion
                 insertInParamTableF parent.ParamContainer

                ///
            let prepareSelectParentbyID (cn:SQLiteConnection) tr =
                let querystring = 
                    "SELECT * FROMParent WHERE ID=@id" 
                let cmd = new SQLiteCommand(querystring, cn, tr)
                cmd.Parameters.Add("@ id ",Data.DbType.Int32) |> ignore
                let rec readerloop (reader:SQLiteDataReader) (acc) =
                    match reader.Read() with
                ...
                ///
            let prepareSelectParentbyName (cn:SQLiteConnection) tr =
                let querystring = 
                    "SELECT * FROMParent WHERE Name=@name" 
                let cmd = new SQLiteCommand(querystring, cn, tr)
                cmd.Parameters.Add("@ name ",Data.DbType.String) |> ignore
                let rec readerloop (reader:SQLiteDataReader) (acc) =
                    match reader.Read() with
                ...
                ///
            let prepareSelectParentbyCountry (cn:SQLiteConnection) tr =
                let querystring = 
                    "SELECT * FROMParent WHERE Country=@country" 
                let cmd = new SQLiteCommand(querystring, cn, tr)
                cmd.Parameters.Add("@ country ",Data.DbType.String) |> ignore
                let rec readerloop (reader:SQLiteDataReader) (acc) =
                    match reader.Read() with
                ...
                ///
            let prepareSelectParentbyRowVersion (cn:SQLiteConnection) tr =
                let querystring = 
                    "SELECT * FROMParent WHERE RowVersion=@rowversion" 
                let cmd = new SQLiteCommand(querystring, cn, tr)
                cmd.Parameters.Add("@ rowversion ",Data.DbType.DateTime) |> ignore
                let rec readerloop (reader:SQLiteDataReader) (acc) =
                    match reader.Read() with
        ...
        let initDB fileName =
            ...
            cn.Open()   
            ///
            Term.createTermTable cn                                                           |> ignore
            Ontology.createOntologyTable cn                                                   |> ignore
            TermTag.createTermTagTable cn                                                     |> ignore
            TermRelationShip.createTermRelationShipTable cn                                   |> ignore
            ///
            Person.createPersonTable cn                                                       |> ignore
            Person.createPersonParamTable cn                                                  |> ignore
            Organization.createOrganizationTable cn                                           |> ignore
            Organization.createOrganizationParamTable cn                                      |> ignore
            AnalysisSoftware.createAnalysisSoftwareTable cn                                   |> ignore
            AnalysisSoftware.createAnalysisSoftwareParamTable cn                              |> ignore
            ///                                                                            
            DBSequence.createDBSequenceTable cn                                               |> ignore
            DBSequence.createDBSequenceParamTable cn                                          |> ignore
            PeptideEvidence.createPeptideEvidenceTable cn                                     |> ignore
            PeptideEvidence.createPeptideEvidenceParamTable cn                                |> ignore
            ModLocation.createModLocationTable cn                                             |> ignore
            ModLocation.createModLocationParamTable cn                                        |> ignore
            Modification.createModificationTable cn                                           |> ignore
            Modification.createModificationParamTable cn                                      |> ignore
            Peptide.createPeptideTable cn                                                     |> ignore
            Peptide.createPeptideParamTable cn                                                |> ignore
            PeptideHypothesis.createPeptideHypothesisParamTable cn                            |> ignore
            ///                                                                            
            SpectrumIdentificationItem.createSpectrumIdentificationItemTable cn               |> ignore
            SpectrumIdentificationItem.createSpectrumIdentificationItemParamTable cn          |> ignore
            SpectrumIdentificationResult.createSpectrumIdentificationResultTable cn           |> ignore
            SpectrumIdentificationResult.createSpectrumIdentificationResultParamTable cn      |> ignore
            SpectrumIdentificationList.createSpectrumIdentificationListTable cn               |> ignore
            SpectrumIdentificationList.createSpectrumIdentificationListParamTable cn          |> ignore
            SpectrumIdentification.createSpectrumIdentificationTable cn                       |> ignore
            SpectrumIdentification.createSpectrumIdentificationParamTable cn                  |> ignore
            SpectrumIdentificationProtocol.createSpectrumIdentificationProtocolTable cn       |> ignore
            SpectrumIdentificationProtocol.createSpectrumIdentificationProtocolParamTable cn  |> ignore
            ///                                                                            
            ProteinDetectionHypothesis.createProteinDetectionHypothesisTable cn               |> ignore
            ProteinDetectionHypothesis.createProteinDetectionHypothesisParamTable cn          |> ignore
            ProteinDetectionList.createProteinDetectionListTable cn                           |> ignore
            ProteinDetectionList.createProteinDetectionListParamTable cn                      |> ignore
            ProteinAmbiguityGroup.createProteinAmbiguityGroupTable cn                         |> ignore
            ProteinAmbiguityGroup.createProteinAmbiguityGroupParamTable cn                    |> ignore
            PeptideHypothesis.createPeptideHypothesisTable cn                                 |> ignore
            ProteinDetectionProtocol.createProteinDetectionProtocolTable cn                   |> ignore
            ProteinDetectionProtocol.createProteinDetectionProtocolParamTable cn              |> ignore
            cn
